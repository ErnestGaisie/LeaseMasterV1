...
enum AlertMessages: String {
    ...
    case invalidAlphabeticString = "Please enter your full name"
    case inValidPSW = "Password must be 6 characters or more"
    
    case emptyPhone = "Empty Phone"
    case emptyEmail = "Email address is required"
    case emptyFirstLetterCaps = "Full name is required oo"
    case emptyAlphabeticString = "Full name is required"
    case emptyPSW = "Please create a password"
