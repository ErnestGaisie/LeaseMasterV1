...
class ExpFloatingLabelTextField: SkyFloatingLabelTextField {
    ...
    private func createErrorLabel() {
        ...
        errorLabel.textColor = UIColor.leaseMasterRed
    ...
    override public func textRect(forBounds bounds: CGRect) -> CGRect {
        ...
        let rect = CGRect(x:15, y:20, width:bounds.size.width - rightMargin - leftMargin, height:bounds.size.height - titleHeight - lineHeight-errorHeight - errorLabelTopMargin)
        return rect
    }
